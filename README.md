...
1. [《冒泡排序》](https://github.com/lmxyjy/algorithm/blob/main/sort/bubble-sort/index.ts)
2. [《选择排序》](https://github.com/lmxyjy/algorithm/blob/main/sort/selection-sort/index.ts)
...
10. [《层序遍历二叉树 II》](https://github.com/lmxyjy/algorithm/blob/main/BFS/sequence-traversal-II/index.ts)
...
14. [《填充每个节点的下一个右侧节点指针 II》](https://github.com/lmxyjy/algorithm/blob/main/BFS/connect-II/index.ts)
15. [《N 叉树的层序遍历》](https://github.com/lmxyjy/algorithm/blob/main/BFS/levelOrder/index.ts)
...
4. [《翻转二叉树》](https://github.com/lmxyjy/algorithm/blob/main/DFS/invert-tree/index.ts)
...
14. [《N 叉树的前序遍历》](https://github.com/lmxyjy/algorithm/blob/main/DFS/preorder-n/index.ts)
15. [《N 叉树的后序遍历》](https://github.com/lmxyjy/algorithm/blob/main/DFS/postorder-n/index.ts)
...
12. [《N 皇后》](https://github.com/lmxyjy/algorithm/blob/main/backtracking/n-queen/index.ts)
...
2. [《求解最小的 k 个数》](https://github.com/lmxyjy/algorithm/blob/main/heap/k/index.ts)
...
7. [《判断是否为对称二叉树》](https://github.com/lmxyjy/algorithm/blob/main/binary-tree/symmetrical/index.ts)
8. [《镜像二叉树》](https://github.com/lmxyjy/algorithm/blob/main/binary-tree/mirror/index.ts)
9. [《取出二叉树中第 k 个最小的值》](https://github.com/lmxyjy/algorithm/blob/main/binary-tree/search-node/index.ts)
10. [《最大深度》](https://github.com/lmxyjy/algorithm/blob/main/binary-tree/max-depth/index.ts)
...
2. [《寻找数组中第一个只出现了一次的数》](https://github.com/lmxyjy/algorithm/blob/main/array/search-num/index.ts)
3. [《重构数组顺序》](https://github.com/lmxyjy/algorithm/blob/main/array/adjust/index.ts)
4. [《乘积数组》](https://github.com/lmxyjy/algorithm/blob/main/array/build/index.ts)
5. [《获取连续数列》](https://github.com/lmxyjy/algorithm/blob/main/array/find-continuous-sequence/index.ts)
6. [《获取子数组最大值》](https://github.com/lmxyjy/algorithm/blob/main/array/find-greatest-sum/index.ts)
7. [《获取满足条件的两个数》](https://github.com/lmxyjy/algorithm/blob/main/array/find-numbers-with-sum/index.ts)
8. [《两数之和》](https://github.com/lmxyjy/algorithm/blob/main/array/two-sum/index.ts)
9. [《判断扑克牌顺子》](https://github.com/lmxyjy/algorithm/blob/main/array/Is-continuous/index.ts)
10. [《三数之和》](https://github.com/lmxyjy/algorithm/blob/main/array/three-sum/index.ts)
11. [《寻找出现次数超过数组长度一半的数》](https://github.com/lmxyjy/algorithm/blob/main/array/search-num2/index.ts)
12. [《二分查找》](https://github.com/lmxyjy/algorithm/blob/main/array/binary-search/index.ts)

## 栈和队列

1. [《求解最小值》](https://github.com/lmxyjy/algorithm/blob/main/stack&queue/stack-create/index.ts)
2. [《用 2 个栈实现队列》](https://github.com/lmxyjy/algorithm/blob/main/stack&queue/implement-stack/index.ts)
